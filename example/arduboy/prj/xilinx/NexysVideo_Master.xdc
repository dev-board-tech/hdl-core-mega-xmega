...
#set_output_delay 0 -clock core_clk [get_ports LED[0]]
#set_output_delay 0 -clock core_clk [get_ports LED[1]]
#set_output_delay 0 -clock core_clk [get_ports LED[2]]
#set_output_delay 0 -clock core_clk [get_ports LED[3]]
#set_output_delay 0 -clock core_clk [get_ports LED[4]]
#set_output_delay 0 -clock core_clk [get_ports LED[5]]
#set_output_delay 0 -clock core_clk [get_ports LED[6]]
#set_output_delay 0 -clock core_clk [get_ports LED[7]]
...
#set_input_delay 1 -min -clock core_clock [get_ports SW[0]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[0]]
#set_input_delay 1 -min -clock core_clock [get_ports SW[1]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[1]]
#set_input_delay 1 -min -clock core_clock [get_ports SW[2]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[2]]
#set_input_delay 1 -min -clock core_clock [get_ports SW[3]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[3]]
#set_input_delay 1 -min -clock core_clock [get_ports SW[4]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[4]]
#set_input_delay 1 -min -clock core_clock [get_ports SW[5]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[5]]
#set_input_delay 1 -min -clock core_clock [get_ports SW[6]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[6]]
#set_input_delay 1 -min -clock core_clock [get_ports SW[7]]
#set_input_delay 1 -max -clock core_clock [get_ports SW[7]]
...
##DDR3
#set_property -dict { PACKAGE_PIN F4   IOSTANDARD SSTL15 } [get_ports { ddr3_cs_n }];# Unconnected
...
#In TCL console:
#set_param synth.elaboration.rodinMoreOptions {rt::set_parameter dissolveMemorySizeLimit 16777216}

#create_clock -period 10.000 -name rst -waveform {0.000 5.000} [get_ports rst]
